---
name: new-skill
description: Scaffold a new skill in this skills repository — copies the template, enforces Agent Skills spec conventions, refreshes the catalog and marketplace manifest, and relinks agent skill directories. Use when asked to create, add, or scaffold a skill.
license: MIT
metadata:
  author: soonjune
...
Create a skill following the Agent Skills open standard conventions used by this skills repository. Skills here serve multiple agents (Claude Code, OpenClaw, Hermes) through the open standard, wired up by symlinks.
