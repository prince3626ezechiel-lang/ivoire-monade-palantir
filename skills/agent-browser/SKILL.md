---
name: agent-browser
description: "Use when a task requires interacting with a browser from the terminal using agent-browser (Vercel Labs). Fast native Rust CLI with accessibility-tree based element selection. Navigate, click, fill forms, screenshot, run batch commands, or use AI chat mode for autonomous browsing."
